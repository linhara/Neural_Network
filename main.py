...
training_data = gzip.open(r'C:\Users\kobbe\train-images-idx3-ubyte.gz', 'r')
training_answers = gzip.open(r'C:\Users\kobbe\train-lables-idx1-ubyte.gz', 'r')
testing_data = gzip.open(r'C:\Users\kobbe\t10k-images-idx3-ubyte.gz', 'r')
testing_answers = gzip.open(r'C:\Users\kobbe\t10k-lables-idx1-ubyte.gz', 'r')
...
def main():
    ...
    for _ in range(iterations):
        ...
        run_network(inputs[a])               #Ger en lista med activations från varje layer, activationOfEachLayer
        cost = calc_cost_prime(activation_of_each_layer[-1], expected)#[a])
        # -------------------------back_prop------------
...
def init_data():
    ...
    buf = training_data.read(image_size * image_size * num_images)
